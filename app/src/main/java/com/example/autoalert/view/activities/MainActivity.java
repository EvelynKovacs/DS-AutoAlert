...
//                    speedViewModel.checkLocationSettings(this); // Solo verificar la configuración si los permisos ya están concedidos
//                } else {
//                    speedViewModel.requestLocationPermissions(this); // Pedir permisos si no están concedidos
//                }
//            });
...
//            super.onStart();
//            Log.i("omg","INICIO");
//            // Inicia el ciclo de verificación al abrir la aplicación
//            checkPermissions();
//        }
    @Override
