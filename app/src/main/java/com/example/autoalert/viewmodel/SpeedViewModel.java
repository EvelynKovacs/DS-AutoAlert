...
//import com.example.autoalert.repository.CsvHelper;
...
public class SpeedViewModel extends AndroidViewModel {
    ...
    public SpeedViewModel(@NonNull Application application) {
        ...
        //csvHelper=new CsvHelper(getApplication().getApplicationContext());
        //csvHelper.createCsvFile(application.getApplicationContext());
