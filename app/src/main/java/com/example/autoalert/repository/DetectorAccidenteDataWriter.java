...
public class DetectorAccidenteDataWriter {
    private static final String FILE_NAME = "accidente_data.txt";


    public static void writeAccidentDataToFile(Context context, String data) {
        try {
