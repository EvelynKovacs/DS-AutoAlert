...
public class LinesAngleDataWriter {

    private static final String FILE_NAME = "lines_data.txt";


    public static void writeLinesDataToFile(Context context, String data) {
        try {
