...
//    @Test
//    public void testCalculateAngleBetweenLines_ParallelLines() {
//        // Parallel lines, expect an angle close to 0 degrees
//        double cx1 = 1.0;
//        double cy1 = 2.0;
//        double cx2 = 2.0;
//        double cy2 = 4.0;
//
//        double slope1 = AccidentDetector.calculateSlope(  cx1, cy1);  // Slope = 2/1
//        double slope2 = AccidentDetector.calculateSlope( cx2, cy2);  // Slope = 2/1
//
//        double angle = AccidentDetector.calculateAngleBetweenLines(slope1, slope2);
//
//        System.out.println("Angle between parallel lines: " + angle);
//        assertEquals("Angle should be 0 for parallel lines", 0, angle, 0.01); // Allowing a small margin
//    }
