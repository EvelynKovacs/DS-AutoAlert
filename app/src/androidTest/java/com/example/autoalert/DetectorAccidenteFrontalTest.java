...
import com.example.autoalert.utils.DetectorAccidenteFrontal;
...
public class DetectorAccidenteFrontalTest {
    private DetectorAccidenteFrontal detectorAccidente;
...
//
        detectorAccidente = new DetectorAccidenteFrontal(context);
    ...
    public void testDesaceleracionNoAccidente() {
        ...
        DatosMovimiento dato3 = new DatosMovimiento(-42.789162, -65.018765, 7, tiempoActual + 2000);  // Desaceleración brusca a 5 m/s
        DatosMovimiento dato4 = new DatosMovimiento(-42.789100, -65.018790, 7, tiempoActual + 3000); // Retoma la velocidad
        DatosMovimiento dato5 = new DatosMovimiento(-42.789050, -65.018810, 7, tiempoActual + 4000); // Continúa movimiento a 12 m/s
        DatosMovimiento dato6 = new DatosMovimiento(-42.789000, -65.018830, 7, tiempoActual + 5000); // Aumenta a 15 m/s
        ...
        DatosMovimiento dato11 = new DatosMovimiento(-42.788750, -65.018930, 5, tiempoActual + 10000); // Reducción brusca a 15 m/s
...
//        DatosMovimiento dato18 = new DatosMovimiento(-42.788400, -65.019070, 0, tiempoActual + 17000);  // Llega a detenerse a 0 m/s
        ...
        detectorAccidente.registrarNuevoDato(dato8);
        detectorAccidente.registrarNuevoDato(dato9); 
        detectorAccidente.registrarNuevoDato(dato10);
        detectorAccidente.registrarNuevoDato(dato11);
...
//        assertTrue(detectorAccidente.registrarNuevoDato(dato18));
    ...
    @Test
    public void testDesaceleracionAccidente() {
        long tiempoActual = System.currentTimeMillis();
        ...
        assertTrue(detectorAccidente.registrarNuevoDato(dato11));
